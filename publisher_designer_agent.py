...
INLINE_STYLES = {
    "h2": 'style="font-family: \'Old Standard TT\', Georgia, serif; font-size: 22px; font-weight: 700; color: #1a1a1a; margin: 32px 0 14px 0; border-bottom: 2px solid #1a1a1a; padding-bottom: 6px; text-transform: uppercase; letter-spacing: 0.5px;"',
    "h3": 'style="font-family: \'Old Standard TT\', Georgia, serif; font-size: 18px; font-weight: 700; color: #1a1a1a; margin: 20px 0 10px 0;"',
    "p": 'style="font-family: \'Crimson Text\', Georgia, serif; font-size: 16px; line-height: 1.6; color: #222222; margin: 0 0 16px 0;"',
    "a": 'style="color: #8b0000; font-weight: 600; text-decoration: underline;"',
    "ul": 'style="font-family: \'Crimson Text\', Georgia, serif; font-size: 16px; line-height: 1.6; color: #222222; padding-left: 20px; margin: 12px 0 16px 0;"',
    "li": 'style="font-family: \'Crimson Text\', Georgia, serif; font-size: 16px; line-height: 1.6; color: #222222; margin-bottom: 8px;"',
    "table": 'style="width: 100%; border-collapse: collapse; margin: 20px 0; border: 1px solid #1a1a1a; font-size: 14.5px;"',
    "th": 'style="background-color: #1a1a1a; color: #f6f1e7; font-family: \'Old Standard TT\', Georgia, serif; font-size: 13px; font-weight: 700; padding: 10px 12px; text-transform: uppercase; letter-spacing: 0.5px; text-align: left;"',
    "td": 'style="font-family: \'Crimson Text\', Georgia, serif; font-size: 14.5px; padding: 10px 12px; border-bottom: 1px solid #d4cebe; color: #222222;"',
    "img": 'style="max-width: 580px; width: 100%; height: auto; border: 2px solid #1a1a1a; margin: 18px auto; display: block;"',
